...
/// <summary>
/// Pins the semantics of <see cref="ShiftEntity{EntityType}.LastReplicationDate"/>: despite the name, it is a
...
{
    private sealed class WatermarkEntity : ShiftEntity<WatermarkEntity> { }

    [Fact]
    public void UpdateReplicationDate_CopiesLastSaveDate_NeverTheCurrentTime()
    {
        // Guard rail: do NOT change UpdateReplicationDate to stamp DateTimeOffset.UtcNow. The feature's first
    ...
    public void SaveDuringReplication_LeavesTheRowDue_ForTheNextSync()
    {
        ...
        entity.UpdateReplicationDate();                         // replication of version T completes
    ...
    [Fact]
    public void UpdateReplicationDate_ExactEquality_MeansInSync()
    {
